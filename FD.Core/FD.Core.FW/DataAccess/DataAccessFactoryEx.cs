...
//        static Dictionary<string,DataAccessFactory1> Factory = new Dictionary<string, DataAccessFactory1>();
        ...
        public static DataAccessFactoryEx GetFactory(string name)
        {
            lock (o)
            {
...
//                else
//                {
                    var a = new DataAccessFactoryEx(name);
//                    Factory.Add(name,a);
                    return a;
//                }
            }
        ...
        public DataAccessFactoryEx(string key)
        {
            SqlConnKey = key;
        }
        public string SqlConnKey = null;
        static DataAccessFactoryEx()
        {
...
//            var itemProp = type.GetProperty("Item");
        ...
        /// <returns></returns>
        public  string ExecuteActionCmdStr(ActionCommand cmd)
        {
        ...
        /// <param name="cmd"></param>
        /// <returns></returns>
        public ResultData ExucetActionCmd(ActionCommand cmd)
        {
        ...
        /// <returns></returns>
        public  ResultData ExecuteStoredProcedureAction(string ActionObjectName, string StoredProcedureName, List<STParamete> parametes)
        {
        ...
        /// <param name="cmd"></param>
        /// <returns></returns>
        private ResultData ExecuteStoredProcedureAction(ActionCommand cmd)
        {
            ...
            var obj = access.Select(type, cmd.Parameter.StoredProcedureParams.StoredProcedureName, cmd.Parameter.StoredProcedureParams.Params);
        ...
        /// <param name="cmd"></param>
        /// <returns></returns>
        private  int UpdateAction(ActionCommand cmd)
        {
            Type type = ReflectionHelper.GetTypeByFullName(cmd.Entity.ActionObjectName);
            var access = GetMsSqlDataAccess();
        ...
        /// <param name="cmd"></param>
        /// <returns></returns>
        private int DeleteAction(ActionCommand cmd)
        {
            Type type = ReflectionHelper.GetTypeByFullName(cmd.Entity.ActionObjectName);
            var access = GetMsSqlDataAccess();
        ...
        /// <param name="cmd"></param>
        /// <returns></returns>
        private int InsertAction(ActionCommand cmd)
        {
            Type type = ReflectionHelper.GetTypeByFullName(cmd.Entity.ActionObjectName);
            var access = GetMsSqlDataAccess();
            if (cmd.Entity.ActionObjectEntryStr.StartsWith("["))
        ...
        /// <param name="cmd"></param>
        /// <returns></returns>
        private int InsertActionV2(ActionCommand cmd)
        {
            Type type = ReflectionHelper.GetTypeByFullName(cmd.Entity.ActionObjectName);
//            fwcon
            var access = GetMsSqlDataAccess();
        ...
        /// <param name="cmd"></param>
        /// <returns></returns>
        public ResultData SelectAction(ActionCommand cmd)
        {
            Type type = ReflectionHelper.GetTypeByFullName(cmd.Entity.ActionObjectName);
            if (type == null)
            {
        ...
        public  List<T> Select<T>(string storedProcedureNae, List<STParamete> parames)
        {
            var access = GetMsSqlDataAccess();
            return access.Select(typeof(T), storedProcedureNae, parames) as List<T>;
        }

        public List<T> Select<T>(string storedProcedureNae, List<STParamete> parames,  ref PageInfo pi)
        {
            var access = GetMsSqlDataAccess();
            return access.Select(typeof(T), storedProcedureNae, parames,  ref pi) as List<T>;
        }
