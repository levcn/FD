    ...
    public class SYS_User : BaseListEntity
    {
        ...
        public List<SYS_UserRoleInfo> Roles
        {
            ...
            set
            {
                ...
                {
                    _roles = value;
                    OnPropertySelectedChanged(() => Roles);
                }
            }
        }
        ...
        public int test
        {
            ...
            set
            {
                ...
                {
                    _test = value;
                    OnPropertySelectedChanged(() => test);
                }
            }
        }
        ...
        public string Account
        {
            ...
            set
            {
                ...
                {
                    _account = value;
                    OnPropertySelectedChanged(() => Account);
                }
            }
        }
        ...
        public string Passwords
        {
            ...
            set
            {
                ...
                {
                    _passwords = value;
                    OnPropertySelectedChanged(() => Passwords);
                }
            }
        }
        ...
        public string UserDetail
        {
            ...
            set
            {
                ...
                {
                    _userDetail = value;
                    OnPropertySelectedChanged(() => UserDetail);
                }
            }
        }
        ...
        public Dict_UserType Dict_UserType
        {
            ...
            set
            {
                if (value != _dict_UserType)
                {
                    ...
                    OnPropertySelectedChanged(() => Dict_UserType);
                }
            }
        }
        ...
        public SYS_UserDetail SYS_UserDetail
        {
            ...
            set
            {
                if (value != _sYS_UserDetail)
                {
                    ...
                    OnPropertySelectedChanged(() => SYS_UserDetail);
                }
            }
        }
        ...
        public string Introduction
        {
            ...
            set
            {
                ...
                {
                    _introduction = value;
                    OnPropertySelectedChanged(() => Introduction);
                }
            }
        }
    }
