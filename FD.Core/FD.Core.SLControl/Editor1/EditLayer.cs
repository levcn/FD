...
namespace SLControls.Editor1
{
    ...
    public class EditLayer:RadWindow
    {
...
//           Background = new SolidColorBrush(Color.FromArgb(255, 180, 200, 255));
           ...
           this.DefaultStyleKey = typeof(EditLayer);

        }

        public static readonly DependencyProperty ControlVisibilityProperty =
                DependencyProperty.Register("ControlVisibility", typeof(Visibility), typeof(EditLayer), new PropertyMetadata(Visibility.Visible, (s, e) =>
                {
                    ((EditLayer)s).OnControlVisibilityChanged(e.NewValue is Visibility ? (Visibility) e.NewValue : Visibility.Visible);
                }));
        ...
        public static readonly DependencyProperty ToSizeProperty =
                DependencyProperty.Register("ToSize", typeof (Size), typeof (EditLayer), new PropertyMetadata(default(Size), (s, e) =>
                {
                    ((EditLayer) s).OnToSizeChanged(e.NewValue is Size ? (Size) e.NewValue : new Size());
                }));
        ...
        public static readonly DependencyProperty ToOpacityProperty =
                DependencyProperty.Register("ToOpacity", typeof (double), typeof (EditLayer), new PropertyMetadata(default(double), (s, e) =>
                {
                    ((EditLayer) s).OnToOpacityChanged(e.NewValue is double ? (double) e.NewValue : 0);
                }));
