...
namespace SLControls.Reflectors
{
    /*
     
      public class AA : CustomTypeHelper<AA>
//        {
//            public string Name { get; set; }
//        }
     //            AA.AddProperty("Age",typeof(int));
//            AA.RemoveProperty("Age");
//            AA a = new AA();
////            a.SetPropertyValue("Age",2);
//            a.Name = "zs";
//            var sdfer=  a.GetProperties();
//            var ererwerwe = a.GetCustomType().GetProperties();
//            var ererwerwe1 = a.GetType().GetProperties();
     */
    ...
    public class CustomTypeHelper<T> : ICustomTypeProvider, INotifyPropertyChanged
    {
        ...
        {
            var item = _customProperties.FirstOrDefault(w => w.Name == name);
            if (item != null)
